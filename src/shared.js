...
export const musicHud = $("musicHud");
export const musicPrevBtn = $("musicPrevBtn");
export const musicPlayBtn = $("musicPlayBtn");
export const musicNextBtn = $("musicNextBtn");
export const musicRepeatBtn = $("musicRepeatBtn");
export const musicShuffleBtn = $("musicShuffleBtn");
export const musicBack10Btn = $("musicBack10Btn");
export const musicForward10Btn = $("musicForward10Btn");
export const musicMuteBtn = $("musicMuteBtn");
export const musicHudVol = $("musicHudVol");
export const musicTrackName = $("musicTrackName");
export const musicElapsed = $("musicElapsed");
export const musicDuration = $("musicDuration");
export const musicProgress = $("musicProgress");
...
export const LEVEL_HP_SCALE = 0.10;
