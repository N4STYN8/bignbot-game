import { DAMAGE } from "./enemies.js?v=202606082258";
...
// CODEX CHANGE: Refresh turret sprite resolution for the new five-level turret sets.
// CODEX CHANGE: Refresh the sprite module after adding the five-level Gravity Trap set.
import { USE_TURRET_SPRITES, SPRITE_ANGLE_OFFSET, TURRET_SPRITE_ANGLE_OVERRIDES, DEFAULT_TURRET_SPRITE_SIZE, TURRET_SPRITE_SCALE_OVERRIDES, getTurretSprite, preloadTurretSprites } from "./sprites.js?v=202607192224";
...
export class Turret {
  ...
  update(game, dt) {
    ...
    if (target && this.cool <= 0) {
      ...
      emitCombatEvent(game, createCombatEvent(COMBAT_EVENT_TYPES.TOWER_FIRE, {
        source: this,
        sourceKey: this.typeKey,
        target,
        damageType: this.dmgType,
        tags: [`tower:${this.typeKey}`]
      }));
      game.explosions.push({
        x: muzzleX,
        y: muzzleY,
