...
(() => {
  ...
  class Game {
    ...
    _waveScalar(wave) {
      ...
      const post5Boost = 1 + post5 * 0.04;
      return {
        hp: (1 + i * 0.09 + latePow) * earlyHp * 1.35 * post5Boost,
        spd: (1 + i * 0.012) * earlySpd * 1.06 * (1 + post5 * 0.015),
        armor: (i * 0.0048 + Math.max(0, wave - 12) * 0.0035) * 1.2 * (1 + post5 * 0.02),
        shield: (1 + i * 0.055 + Math.max(0, wave - 12) * 0.015) * 1.12 * (1 + post5 * 0.02),
        regen: (1 + i * 0.035 + Math.max(0, wave - 12) * 0.015) * 1.12 * (1 + post5 * 0.015),
